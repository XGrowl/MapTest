...
public class NavigationActivity extends CheckPermissionsActivity implements INaviInfoCallback {
...
//    private ListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AmapNaviParams params=new AmapNaviParams(null,null,new Poi("故宫博物馆",p2,""),AmapNaviType.DRIVER);
        params.setUseInnerVoice(true);
        AmapNaviPage.getInstance().showRouteActivity(getApplicationContext(),params, NavigationActivity.this);
       // AmapNaviPage.getInstance().showRouteActivity(this, new AmapNaviParams(null), NavigationActivity.this);
    }
